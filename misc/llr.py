...
from misc.slid import slid_tendency
from misc.laps import laps_intersections, laps_cluster
...
def LLR(img, points, lines):
	...
	from misc.laps import laps_intersections
	# debug.image(img) \
